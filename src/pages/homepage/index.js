...
$('#header.header .header-content .nav').mouseenter(function() {
  if (flag) {
    ...
    $('#logo-img').attr('src', 'https://wsi.oss-cn-shanghai.aliyuncs.com/images/appendix/1611887097099bsyPwM/blacklogo.svg')
  }
})
...
$('#header.header .header-content .nav').mouseleave(function() {
  if (flag) {
    ...
    $('#logo-img').attr('src', 'https://wsi.oss-cn-shanghai.aliyuncs.com/images/appendix/1611887097099bsyPwM/whitelogo.svg')
  }
})
